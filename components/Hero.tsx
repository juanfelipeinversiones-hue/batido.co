    ...
    <section className="relative min-h-[92vh] flex items-center justify-center px-6 pt-28 pb-16 sm:pt-32 sm:pb-20 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto w-full">
        <div className="space-y-6 text-center">
          <h2 className="text-[#557C5C] text-xs md:text-sm font-extrabold uppercase tracking-[0.3em] opacity-90">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 text-[11px] font-bold uppercase tracking-widest text-zinc-600">
            <span className="px-4 py-2 rounded-full border border-black/10 bg-white/70">Entrega sujeta a disponibilidad</span>
            <span className="px-4 py-2 rounded-full border border-black/10 bg-white/70">Pagos: Nequi, Daviplata, tarjeta o efectivo</span>
